...
resource "vault_aws_auth_backend_role" "consul" {
  ...
  token_policies      = sort(concat(var.base_policies, var.consul_policies))
...
resource "vault_aws_auth_backend_role" "nomad_server" {
  ...
  token_policies      = sort(concat(var.base_policies, var.nomad_server_policies))
  token_period        = var.period_minutes
}
...
resource "vault_aws_auth_backend_role" "nomad_client" {
  ...
  token_policies      = sort(concat(var.base_policies, var.nomad_client_policies))
  token_period        = var.period_minutes
}
...
resource "vault_aws_auth_backend_role" "vault" {
  ...
  token_policies      = sort(concat(var.base_policies, var.vault_policies))
  token_period        = var.period_minutes
}
